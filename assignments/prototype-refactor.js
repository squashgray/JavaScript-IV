...
class GameObject {
    constructor(attributes){
        ...
        this.dimensions =attributes.dimensions //remember no comma on the last, will give error //
    }
    destroy() {
        return `${this.name} was removed from the game.`;   // this is the prototype //
    }
}

class CharacterStats extends GameObject {
    constructor(charAttributes){
        super(charAttributes);   // extends + super are what bind child to parent (CharacterStats to GameObject) //
        this.healthPoints = charAttributes.healthPoints
    }
    takeDamage(){
        return ` ${this.name} took damage. `;   //prototype//
    }
}
...
class Humanoid extends CharacterStats {
    ...
    greet = function() {
        return `${this.name} offers a greeting in ${this.language} .`; //prototype//
}
}
